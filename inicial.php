...
<nav class="navbar navbar-expand-lg static-top">
  <div class="container">
    ...
    <a class="title" href="inicial.php">FootApostas</a>
    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="index.php">Jogos</a>
        </li>
        <li class="nav-item">
...
<div class="main-conteudo">
        ...
        <img src="/img/letra.png" alt="">
        </div>
        <div class="left-conteudo">
            <img src="img/soccer.svg" class="left-login-image" alt="Animação portal">
        </div>
    </div>
</body>
</html>